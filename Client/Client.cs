 ...
 * 
 * Required Files:
 * - Client.cs, ITest.cs, Logger.cs, CS-BlockingQueue.cs, Communication.cs, Messages.cs
 * 
 * Maintenance History:
 * --------------------
 * ver 1.0 : 20 Oct 2016
...
namespace TestHarness
{
    public class Client : IClient
    {
        ...
        */
        ...
        // used for creating a file streaming channel
        IStreamService channel;
        string ToSendPath = "..\\..\\ClientToSend";
        string SavePath = "..\\..\\SavedFiles";
        int BlockSize = 1024;
        byte[] block;
        HRTimer.HiResTimer hrt = null;

        // used for creating a WCF channel
        ...
        string xmlReq = @"..\..\..\XMLRequestsFolder\Client1_TestRequest.xml";
        ...
        static void Main(string[] args)
        {
            ...
            hrt.Start();
            client.uploadFile("AnotherTestDriver.dll");
            client.uploadFile("AnotherTestedCode.dll");
            client.uploadFile("TestDriver.dll");
            client.uploadFile("TestedCode.dll");
            hrt.Stop();
            Console.Write(
            ...
            Message msg = client.makeMessage("Mark Dwayne", client.endPoint, client.endPoint);
            ...
            Message repoQuery = client.makeRepoMessage("Mark Dwayne", "Client1", client.endPoint, repoEndPoint, "Mark Dwayne");
